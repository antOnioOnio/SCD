...
// en orden arbitrario
// (versión con varios productores y consumidores)
//
// Historial:
// Actualizado a C++11 en diciembre de 2017
// -----------------------------------------------------------------------------
...
{ 
   int contador = num_orden; 
   sleep_for( milliseconds( aleatorio<10,100>()) );
   
   cout << "Productor ha producido valor "<< endl << flush;
   return contador;
}
// ---------------------------------------------------------------------
