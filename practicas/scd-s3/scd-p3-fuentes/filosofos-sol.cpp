...
void funcion_tenedores( int id )
{
  ...
  while ( true )
  {
     ...
     MPI_Recv (&valor, 1, MPI_INT, MPI_ANY_SOURCE, etiq_comer ,MPI_COMM_WORLD, &estado);
     ...
     MPI_Recv (&valor, 1, MPI_INT, id_filosofo , etiq_comer ,MPI_COMM_WORLD, &estado);
